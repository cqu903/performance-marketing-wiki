...
6. 如果启用 [[meta-marketing-api]]，资产表还要记录 Business Manager、Ad Account ID、Meta App ID、System User、token owner、`ads_read` / `ads_management` 授权范围和 Access Tier。
