...
sources: [raw/articles/360011890298-ios14-att-skan-faq.md, raw/articles/19228737402129-meta-ios-aem.md, raw/articles/115002504686-google-ads-integration.md, raw/articles/207447053-appsflyer-attribution-model.md, raw/articles/20260624-xwallet-af-postback-source-scope-discussion.md, raw/articles/20260705-appsflyer-sdk-onelink-ios-noidfa-full-notes.md, raw/articles/20260705-meta-capi-w2a-credit-lending-review.md]
confidence: high
---
...
## CAPI 补充 iOS 归因损耗
W2A 链路 iOS 归因兜底方案除了 H5 部署 AF 网页脚本缓存 af_clickid 做精准归因外，还需 Meta CAPI 补充用户特征信号（加密手机号、fbclid/fbp）提升 EMQ 匹配精度。双向弥补 SKAN 精度不足和 IDFA 关闭导致的大规模归因丢失。AF 中转 postback 仅传设备 ID，无法携带多维用户信号，iOS 无 IDFA 场景下 EMQ 偏低、匹配损耗大。详见 [[meta-capi]] 和 [[af-vs-meta-capi]]。^[raw/articles/20260705-meta-capi-w2a-credit-lending-review.md]
